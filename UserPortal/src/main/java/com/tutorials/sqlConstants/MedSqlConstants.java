...
public class MedSqlConstants {
	...
	public final static String queryForCreditDetailsList="select distinct CardName,CardNum,CreditExp,CredExpMonth,ExpenseYear,Comment,CardType,CardUser from creditcard";
