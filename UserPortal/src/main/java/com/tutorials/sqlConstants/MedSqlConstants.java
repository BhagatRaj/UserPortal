...
public class MedSqlConstants {
	...
	public final static String getEmployementDetails="select EmpID, EmpName, CompanyName, DOJ, WorkingLocation, Tower, AppTower, TechSpecs from employmentdetails where CompanyName=?";
}
