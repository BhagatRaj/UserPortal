package com.tutorials.FileUploadService;
		...
		Workbook workbook = null;
			...
			try 
			{
				...
				String headerNames[] = headerDetails.split(",");
				 ...
				 ArrayList<ExcelVO> employeeList = new ArrayList<>();
				 ...
				 while(rowIterator.hasNext()) 
				 {
				        ...
				        ExcelVO excelTemplateVO = new ExcelVO();
				        int count=0;
				        while(count<headerNames.length){
				        	...
				        	setValueIntoObject(excelTemplateVO, ExcelVO.class, methodName, "java.lang.String", inputCellValue);
				        }
